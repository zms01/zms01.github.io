...
window.Tilda=window.Tilda||{};(function($){Tilda.sendEventToStatistics=function(virtPage,virtTitle,referer,price){var isVirtPage=virtPage.substring(0,1)=='/'?!0:!1;var arProducts=[],p=0;if(!referer){referer=window.location.href}
